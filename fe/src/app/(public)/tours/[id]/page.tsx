    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_340px]">
        ...
        <aside className="h-fit rounded-3xl border border-[#cdece0] bg-white p-5 shadow-[0_18px_30px_rgba(7,68,50,0.06)]">
          ...
          <p className="mt-4 text-base text-[#285447]">Khởi hành: {tour.departureLocation}</p>
          <p className="mt-1 text-base text-[#285447]">Điểm đến: {tour.destinationLocation}</p>
          <p className="mt-1 text-base text-[#285447]">Số chỗ toàn tour: {tour.slotsAvailable}</p>

          <a
            href="#lich-khoi-hanh"
            className="mt-5 inline-flex w-full items-center justify-center rounded-xl bg-[#0a7d59] px-4 py-3 text-base font-semibold text-white transition hover:bg-[#085a41]"
          >
            Chọn ngày khởi hành
          </a>
