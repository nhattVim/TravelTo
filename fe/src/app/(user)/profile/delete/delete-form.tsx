  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-[#ffefef] pb-4">
        <h2 className="text-xl font-bold text-[#b92b2b]">Xóa tài khoản vĩnh viễn</h2>
        <p className="mt-1 text-sm text-[#7c4d4d]">
      ...
      <div className="rounded-2xl border border-[#ffe0e0] bg-[#fff5f5] p-5 text-sm text-[#d14f4f]">
      ...
      <div className="pt-2">
        <button
          ...
          disabled={loading}
          className={`rounded-2xl px-8 py-3.5 text-sm font-bold uppercase tracking-widest text-white shadow-md transition ${
