...
export default async function AdminUsersPage() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#0a7d59]">User Management</p>
        <h2 className="mt-2 text-4xl font-semibold text-[#083b2d]">Quản lí user</h2>
      ...
      <section className="rounded-2xl border border-[#cdece0] bg-white p-5">
        <div className="mb-4 flex items-center justify-between gap-3">
          <p className="text-base text-[#355a4d]">
        ...
        {users.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-left text-base text-[#355a4d]">
              <thead>
                <tr className="border-b border-[#def1e9] text-sm uppercase tracking-wide text-[#0a7d59]">
