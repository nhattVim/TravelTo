...
export default async function SetPasswordPage({ searchParams }: SetPasswordPageProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl rounded-3xl border border-[#cdece0] bg-white p-8 shadow-[0_18px_40px_rgba(10,93,66,0.08)] md:p-12">
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#0a7d59]">Thiết lập lần đầu</p>
      <h1 className="mt-3 text-3xl font-bold text-[#083b2d] md:text-4xl">Tạo mật khẩu cho tài khoản của bạn</h1>
